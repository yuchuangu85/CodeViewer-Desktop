...
/*
	public static void main(String[] args) {
		...
		fife.ui.rsyntaxtextarea.RSyntaxTextArea textArea = new
			fife.ui.rsyntaxtextarea.RSyntaxTextArea(25, 40);
		...
		frame.setContentPane(new fife.ui.rtextarea.RTextScrollPane(textArea));
		frame.pack();
